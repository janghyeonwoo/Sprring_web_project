...
function list(page){
	location.href="${path}/board/list.do?curPage="+page+"&search_option=${map.search_option}"
			+"&keyword=${map.keyword}";
}

console.log('${map.search_option}');
...
<c:forEach var="row" items="${map.list}">
	<tr>
		...
		<td>${row.name}</td>
		<td><fmt:formatDate value="${row.regdate}" pattern="hh-MM-dd HH:mm:ss"/></td>
		<td>${row.viewcnt}</td>
	</tr>
</c:forEach>
<!-- 페이지 네비게이션 -->
